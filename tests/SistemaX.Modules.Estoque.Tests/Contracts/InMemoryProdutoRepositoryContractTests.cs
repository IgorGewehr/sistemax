...
public sealed class InMemoryProdutoRepositoryContractTests : ProdutoRepositoryContractTests
{
    protected override IProdutoRepository CriarRepositorio() => new InMemoryProdutoRepository();
}
