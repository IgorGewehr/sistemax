...
/**
 * KPI clicável — cópia local do padrão `components/compras/KpiClickable.tsx` (o `KpiCard` de
 * `shared` não expõe `onClick`/estado ativo). Replica a mesma superfície (`.surface`) com borda de
 * marca quando ativo. Nunca `active:scale` (encolhe a hitbox) — só `active:brightness-95`.
 */
