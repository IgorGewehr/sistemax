...
/**
 * Mesma API/aparência do `MoneyValue` compartilhado, mas sem casas decimais — o mockup de
 * Entradas & saídas nunca mostra ',00' (ver `./money.ts`). Fica local a esta tela porque o
 * `MoneyValue` de `components/financial/shared` é usado por outras telas do financeiro que
 * precisam exibir centavos, e não deve ser alterado fora de sua própria tela.
 */
