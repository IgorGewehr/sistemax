...
/** Área + linha com ponto final do KPI hero "Vendido no mês" — cópia local do desenho de
 * `components/compras/Sparkline.tsx` (não é genérico o bastante ainda pra ir pro shared). */
